...
import { CarouselDefault } from '../../components/common/Image/Carousel';
import BackBar from '../../components/common/Navbar/BackBar';
  ...
  return (
    <div className="grid pt-5 pb-4">
      ...
      <div className="px-6">
        ...
        <div>
          <p className="font-semibold text-lg">더 많은 옵션 보기</p>
        </div>
